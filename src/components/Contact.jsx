...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://bsease8jvk.execute-api.ap-south-1.amazonaws.com/default/contactFormHandler",
        {
          method: "POST",
  ...
  const contactDetails = [
    {
      icon: Mail,
      label: "taimooor786786@gmail.com",
      href: "mailto:taimooor786786@gmail.com",
      delay: 0.5,
    },
    {
      icon: Phone,
      label: "0310-6519763",
      href: "tel:0310-6519763",
      delay: 0.65,
    },
